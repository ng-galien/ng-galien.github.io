...
last_modified_at: 2025-11-08 13:15:00 +0100
...
Un **ADT** (Algebraic Data Type) est une structure de données définie par une **somme de variantes** (types disjoints) où chaque variante peut porter ses propres attributs (produit de champs). Les ADT sont courants en programmation fonctionnelle (Haskell, OCaml, F#) et se rapprochent des **types discriminés** ou **union types** dans d’autres langages.

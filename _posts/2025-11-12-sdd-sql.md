...
tags: [State-Driven Design, SDD, SQL, PostgreSQL, Data Modeling, Architecture]
...
3. **Les transitions sont des références** : chaque ligne d’un état pointe vers l’état précédent (ou une table de mapping pour les cas « OU » comme `canceled_source`).

...
> Note de refonte : ce blog parlait initialement de « Graph‑Driven Design » (GDD).
> Nous généralisons l’approche sous le nom « State‑Driven Design » (SDD) où
> l’**état** est la primitive centrale de la modélisation. Les graphes restent
> un excellent outil d’implémentation pour relier faits, contextes et parcours. {: .prompt-info }
...
Dans la [suite de cet article](/2025/11/01/gdd/), nous explorons en profondeur
...
→ [Lire la suite : Des tables fourre-tout aux relations fonctionnelles](/2025/11/01/gdd/)

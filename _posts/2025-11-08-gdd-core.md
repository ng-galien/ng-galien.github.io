...
layout: post
lang: fr
title: "SDD : 20 axiomes cœur et réalisation SQL"
...
tags: [sdd, state-driven design, gdd, graph-driven design, data modeling, domain-driven design, ddd, sql, architecture]
permalink: /2025/11/08/gdd-core/
page_id: article-gdd-core
nav_section: articles
toc: true
---

{:.lead}
Ce document condense les principes structurants pour modéliser des **états métier** stables et dérivables, avec des **transitions explicites** et une **traçabilité append‑only**. Il prolonge l'introduction publiée dans [l’article introductif](/2025/11/01/gdd-intro/) et complète la vue d’ensemble présentée dans [Des tables fourre-tout aux relations fonctionnelles](/2025/11/01/gdd/).

> _Note de refonte (GDD → SDD)_ : Le terme « Graph‑Driven Design » est remplacé par **State‑Driven Design (SDD)** pour insister sur l’ADT d’états et transitions ; le graphe reste une option d’implémentation pour le parcours.
>
...
- Origine du besoin et symptômes du modèle data‑first : [Introduction SDD](/2025/11/01/gdd-intro/)
- Construction relationnelle complète : [Article principal](/2025/11/01/gdd/)

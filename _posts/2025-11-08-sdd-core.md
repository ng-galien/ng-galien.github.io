...
Les types union sont courants en programmation fonctionnelle (Haskell, OCaml, F#) et se rapprochent des **types discriminés** ou **union types** dans [les languages de la vie réelle](#adt-dans-les-langages-de-la-vie-réelle).
